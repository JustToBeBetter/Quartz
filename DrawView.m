...
- (void)drawRect:(CGRect)rect {
    ...
    //NO.3画一个正方形图形 没有边框
     ...
     CGContextSetRGBFillColor(context, 0, 0.25, 0, 0.5);//青绿色
     CGContextFillRect(context, CGRectMake(10, 20, 300, 100));
     CGContextStrokePath(context);
    ...
    //NO.4画正方形边框
     ...
     CGContextAddRect(context, CGRectMake(10, 20, 300, 100));
     CGContextStrokePath(context);
    ...
    //NO.5画方形背景颜色
     ...
     CGContextTranslateCTM(context, 0.0f, 300);
     CGContextScaleCTM(context, 1.0f, -1.0f);
     UIGraphicsPushContext(context);
     CGContextSetLineWidth(context,5);
     CGContextSetRGBStrokeColor(context, 250.0/255, 250.0/255, 210.0/255, 1.0);
     CGContextStrokeRect(context, CGRectMake(10, 100, 320, 50));
